...
for agenku in range(10000):
	a='Dalvik/2.1.0 (Linux; U; Android 7.0;'
	b=random.choice(['7.0','8.1.0','9','10','11','12'])
	c='BTV-DL09 Build/HUAWEIBEETHOVEN-DL09)'
	...
	a='Mozilla/5.0 (Linux; Tizen 4.0;'
	b=random.choice(['6.0.1','7.1.1','8.1.0'])
	c='SAMSUNG SM-R500)'
	d='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.0'
	e=random.randrange(83,103)
	f='0'
	g=random.randrange(4200,4900)
	h=random.randrange(40,150)
...
for agenkuw in range(10000):
	...
	c='Tizen 5.0)'
	d='AppleWebKit/537.63 (KHTML, like Gecko) Version/5.0 TV'
	e=random.randrange(83,103)
	f='0'
	g=random.randrange(4200,4900)
	h=random.randrange(40,150)
